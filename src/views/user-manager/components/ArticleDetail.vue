  ...
  <div class="createPost-container">
    <el-form class="form-container" :model="postForm" :rules="rules" ref="postForm">
      ...
      <div class="createPost-main-container">
        <el-row>
          <el-col :span="21">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="65px" label="用户名:" class="postInfo-container-item">
                    <multiselect v-model="postForm.author" :options="userLIstOptions" @search-change="getRemoteUserList" placeholder="支持检索" selectLabel="选择"
                ...
                <el-col :span="8">
                  <el-tooltip class="item" effect="dark" content="所属部门" placement="top">
                    <el-form-item label-width="80px" label="所属部门:" class="postInfo-container-item">
                      <el-input placeholder="所属部门" style='min-width:150px;' v-model="postForm.source_name1">
                      </el-input>
                    </el-form-item>
                  </el-tooltip>
                </el-col>
                ...
                <el-col :span="8">
                  <el-tooltip class="item" effect="dark" content="分配角色" placement="top">
                    <el-form-item label-width="80px" label="分配角色:" class="postInfo-container-item">
                      <el-button type="primary" @click='openPropRole()' size="small" icon="el-icon-edit">创建</el-button>
                    </el-form-item>
                  </el-tooltip>
                </el-col>
                <!--
        ...
        <div style="margin-bottom: 20px;">上传头像：
