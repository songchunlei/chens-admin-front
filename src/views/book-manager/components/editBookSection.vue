    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <div class="siderMenu" v-show="menusData">
          <book-tree :data="menusData" @updateTree="updateTree"></book-tree>
        </div>
      </el-col>
      <el-col :span="16" class="p-md">   
        ...
        <div class="containerForm" v-show="showForm">
          ...
          <book-form :form="form" @subForm="subForm" :handleStatus="handleStatus"></book-form>
        </div>
      </el-col>
    </el-row>
  </div>
